...
if [[ $# -lt 2 ]]; then
  ...
  echo ""
  echo "Example:"
  echo "  $0 /path/to/dataset metadata.csv joint_rgbxyz_lora \\"
  echo "    experiment.training.batch_size=1 algorithm.lora.rank=16 \\"
