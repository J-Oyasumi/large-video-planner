...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        output = {
            ...
            "has_bbox": has_bbox,
            "video_path": str(self.data_root / record["rgb_path"]),
        }
    ...
    def _load_video(self, record: Dict[str, Any]) -> torch.Tensor:
        ...
        video_path = self.data_root / record["rgb_path"]
    ...
    def _check_record(self, x: Dict[str, Any]) -> bool:
        ...
        """
        video_path = self.data_root / x["rgb_path"]
...
class RGBXYZDataset(VideoDataset):
    ...
    def _load_xyz(self, record: Dict[str, Any]) -> torch.Tensor:
        ...
        frames = np.load(xyz_path)["xyz"].transpose(0, 3, 1, 2)
